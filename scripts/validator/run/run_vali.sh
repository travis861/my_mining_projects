...
POKER44_MINERS_PER_CYCLE="${POKER44_MINERS_PER_CYCLE:-0}"
POKER44_SYNCED_WINDOW_MODE="${POKER44_SYNCED_WINDOW_MODE:-true}"
POKER44_SYNC_ALL_MINERS="${POKER44_SYNC_ALL_MINERS:-true}"
POKER44_SYNC_DIRECT_SCORE_UPDATE="${POKER44_SYNC_DIRECT_SCORE_UPDATE:-true}"
POKER44_SYNC_RESET_BUFFERS_ON_WINDOW_CHANGE="${POKER44_SYNC_RESET_BUFFERS_ON_WINDOW_CHANGE:-true}"
